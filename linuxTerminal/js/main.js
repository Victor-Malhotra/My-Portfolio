...
var files = (function() {
    ...
    Singleton.defaultOptions = {
        "about.txt": "This website was made using only pure JavaScript with no extra libraries.\nI made it dynamic so anyone can use it, just download it from GitHub and change the config text according to your needs.\nIf you manage to find any bugs or security issues feel free to email me: victorrmalhotra@gmail.com",
        "getting_started.txt": "Start by typing whoami, then type help",
        "contact.txt": "Contact me at victorrmalhotra@gmail or call +1(602) 784-0144",
        "social_network_1.txt": "",
        "social_network_2.txt": ""
    };
    return {
        getInstance: function(options) {
            instance === void 0 && (instance = new Singleton(options));
